...
# NOTE: Pine Script export removed. Pine cannot drive TradingView's native
# Fib Circle tool and has no pixel access, so any polyline "circle" distorts
# off the 1D timeframe. Use the GH coordinate table in the UI to place circles
# by hand with TV's native Fib Circle tool, or the in-app GH overlay.
